...
import MushroomJar from "./MushroomJar";
...
const ClockRoom = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url(${ClockRoomImg})` }}
    >
      <LoadingScreen />
      ...
      <Clock />
      <div
        className="clock-hour-sm clock-hand-sm"
        style={{ transform: `rotate(${time.hour * 30}deg)` }}
      ></div>
      <div
        className="clock-minute-sm clock-hand-sm"
        style={{ transform: `rotate(${time.minute * 6}deg)` }}
      ></div>

      <div
        className="starBox-clickbox"
        onClick={() => changeScene("starBox", "main")}
      ></div>
      <div
        className="book0-clickbox"
        onClick={() => changeScene("book0", "main")}
      ></div>
      <div
        className="book1-clickbox"
        onClick={() => changeScene("book1", "main")}
      ></div>

      <div
        className="crossword-clickbox"
        onClick={() => changeScene("crossword", "main")}
      ></div>
      <div
        className="moonBox-clickbox"
        onClick={() => changeScene("moonBox", "main")}
      ></div>
      <div
        className="safe-clickbox"
        onClick={() => changeScene("safe", "main")}
      ></div>
